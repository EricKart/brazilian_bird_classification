...
# Convert categorical labels and features
label_encoder = LabelEncoder()
df['migrant'] = label_encoder.fit_transform(df['migrant'])

# Assuming all other columns are features and preparing for one-hot encoding
# Adjust based on your dataset's features
X = df.drop('migrant', axis=1)
y = df['migrant']
